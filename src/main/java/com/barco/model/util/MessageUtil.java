...
public interface MessageUtil {
    ...
    public static final String ACTION_MISSING = "Action missing.";
    ...
    public static final String ACCOUNT_ENABLED = "Account enabled for %s user";
    public static final String ACCOUNT_DISABLED = "Account disabled for %s user";
    public static final String ACCOUNT_CLOSE_DETAIL = "Account closed for %s user.";
