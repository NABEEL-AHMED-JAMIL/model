...
public class TaskDto {
    ...
    private AccessServiceDto accessService;
    ...
    public AccessServiceDto getAccessService() {
        return accessService;
    }
    public void setAccessService(AccessServiceDto accessService) {
    ...
    public StorageDetailDto getStorageDetail() {
        return storageDetail;
    }
    public void setStorageDetail(StorageDetailDto storageDetail) {
