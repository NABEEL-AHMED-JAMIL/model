...
public class TagInfoResponse implements Comparable<TagInfoResponse> {
    ...
    public TagInfoResponse(String tagKey, String tagParent, String tagValue) {
        this.tagKey = tagKey;
        this.tagParent = tagParent;
        this.tagValue = tagValue;
    }

    public TagInfoResponse(Long taskPayloadId, String tagKey, String tagParent, String tagValue) {
    ...
    public boolean equals(Object o) {
        ...
        TagInfoResponse tagInfoRequest = (TagInfoResponse) o;
    ...
    @Override
    public int compareTo(TagInfoResponse o) {
